      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-vice-cyan font-body">Personalized offer creation</p>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="mission-card">
              <CardHeader>
                <CardTitle className="font-gta text-vice-pink">OFFER CAMPAIGN</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12">
                  <FileText className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
                  <h3 className="text-xl font-gta text-muted-foreground mb-2">NO OFFERS TO GENERATE</h3>
                  <p className="text-muted-foreground mb-6">
                    Underwriter will send approved deals here for offer creation
                  </p>
                  <Button
                    variant="neon-orange"
                    size="lg"
                    onClick={() => navigate("/agent/underwriter")}
                    className="px-8"
                  >
          ...
          <div>
            <Card className="mission-card">
              <CardHeader>
                <CardTitle className="font-gta text-vice-cyan">OFFER STRATEGIES</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-sm text-muted-foreground">
                  <p className="mb-2">Offer Types:</p>
                  <ul className="space-y-1 text-xs">
                    <li>• Cash offers</li>
                    <li>• Creative financing</li>
                    <li>• Wholesale assignments</li>
                    <li>• Subject-to deals</li>
                  </ul>
                </div>
                ...
                <div className="pt-4 border-t border-border">
                  ...
                  <div className="flex items-center gap-2">
                    <Send className="w-4 h-4 text-vice-purple" />
                    <span className="text-sm font-gta text-vice-purple">CONTRACT SPECIALIST</span>
                  </div>
                </div>
              </CardContent>
            </Card>
