...
VALUES 
  ('YOUR_ACCOUNT_ID', 'initial_offer', 'Seller Finance - Initial', 
...
('YOUR_ACCOUNT_ID', 'initial_offer', 'Subject-To - Initial',
...
('YOUR_ACCOUNT_ID', 'follow_up_1', 'Follow-Up #1',
 'Re: {address}',
 'Hi {agent_name},
...
GTA 6 Real Estate', true),

-- TEMPLATE 4: Follow-Up #2 (7 Days)
('YOUR_ACCOUNT_ID', 'follow_up_2', 'Follow-Up #2',
...
('YOUR_ACCOUNT_ID', 'objection_low', 'Objection - Price Low',
...
The key question: Would your seller prefer {full_price} over time with interest, or are they strictly looking for all-cash today?
...
-- SELECT template_type, name, active FROM email_templates WHERE account_id = 'YOUR_ACCOUNT_ID';
