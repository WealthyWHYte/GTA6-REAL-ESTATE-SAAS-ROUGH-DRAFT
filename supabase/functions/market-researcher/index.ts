    ...
    return __generator(this, function(_b) {
      switch(_b.label){
        ...
        case 2:
          ...
          _b.label = 3;
        case 3:
          if (!(_i < properties_1.length)) return [
            3 /*break*/ ,
            11
          ];
        ...
        case 4:
          ...
          return [
            4 /*yield*/ ,
            performMarketResearch(property)
          ];
        case 5:
          marketData = _b.sent();
          results.push({
    ...
    return __generator(this, function(_a) {
      switch(_a.label){
        case 0:
          ...
          confidence = 'low';
          dataPoints = 0;
          if (!API_CONFIGS.zillow.apiKey) return [
            3 /*break*/ ,
            4
          ];
          _a.label = 1;
        ...
        case 4:
          ...
          _a.label = 5;
        case 5:
          if (!(_i < scrapingSources_1.length)) return [
            3 /*break*/ ,
            10
          ];
        ...
        case 6:
          ...
          return [
            4 /*yield*/ ,
            simulateWebScraping(property, source)
          ];
        case 7:
          scrapedData = _a.sent();
          if (scrapedData) {
      ...
      switch(_a.label){
        case 0:
          ...
          return [
            4 /*yield*/ ,
            new Promise(function(resolve) {
              return setTimeout(resolve, 1500 + Math.random() * 2000);
            })
          ];
        case 1:
          // Simulate web scraping delay
      ...
      switch(_a.label){
        case 0:
          ...
          return [
            4 /*yield*/ ,
            new Promise(function(resolve) {
              return setTimeout(resolve, 800 + Math.random() * 1200);
            })
          ];
        case 1:
          // Simulate RentalMeter API delay
