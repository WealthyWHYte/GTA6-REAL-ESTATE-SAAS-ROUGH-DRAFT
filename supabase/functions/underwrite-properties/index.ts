  ...
  try {
    ...
    for (const property of properties) {
      ...
      const { error: insertError } = await serviceClient.from('property_analysis').insert({
        ...
        level1_mortgage_monthly: analysis.level1_mortgage_monthly,
        level1_carry_monthly: analysis.level1_carry_monthly,
        ...
        level3_mortgage_monthly: analysis.level3_mortgage_monthly,
        level3_carry_monthly: analysis.level3_carry_monthly,
        ...
        mortgage_rate: analysis.mortgage_rate,
